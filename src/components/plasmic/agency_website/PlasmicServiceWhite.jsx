...
import BlueBdr from "../../BlueBdr"; // plasmic-import: r-QFPFcU3uaM/component
...
import * as sty from "./PlasmicServiceWhite.module.css"; // plasmic-import: Qe_Hmrr_jlV3/css
...
function PlasmicServiceWhite__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox___3N5Nq)}>
        {renderPlasmicSlot({
          defaultContents: (
            <BlueBdr
              className={classNames("__wab_instance", sty.blueBdr__eqikc)}
            />
          ),
      ...
      <div className={classNames(projectcss.all, sty.freeBox__rkQj)}>
        {renderPlasmicSlot({
          defaultContents:

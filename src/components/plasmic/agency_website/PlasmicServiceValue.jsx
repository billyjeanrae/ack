...
import * as sty from "./PlasmicServiceValue.module.css"; // plasmic-import: dJL4NKbYi32E/css
...
function PlasmicServiceValue__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__b8YQ0)} />
      <div className={classNames(projectcss.all, sty.freeBox__cqFYj)}>
        {renderPlasmicSlot({
          defaultContents:

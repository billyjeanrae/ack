...
import * as sty from "./PlasmicTextInput.module.css"; // plasmic-import: XpIpa1sfrmeh/css
import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: 9c5rMu3vAHu8/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__kopKv)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg___3X6Dd)}
              role={"img"}
            />
          ),
